...
class BitsetTest: XCTestCase {
    ...
    func testFormulaAsBitset() {
        ...
        // Create Sample APs
        let ap_a = AP(name: "a", observable: true, list: globalAPList, output: true)
        let ap_b = AP(name: "b", observable: true, list: globalAPList, output: true)
        let ap_c = AP(name: "c", observable: true, list: globalAPList, output: true)
        let ap_d = AP(name: "d", observable: true, list: globalAPList, output: true)
